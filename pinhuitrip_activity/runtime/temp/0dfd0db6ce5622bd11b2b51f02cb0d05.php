<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\wamp64\www\pinhuitrip_activity\public/../application/index\view\point\index.html";i:1503975581;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        /* 抬头的背景图片 */
        .title_bg{
            background:url('__STATIC__/index/<?php echo $site_details_data['site_bg_img']; ?>');
...
<body>
    ...
    <div id="card_div">
        <div class="card" >
            ...
            <p class="title"><?php echo $site_details_data['details_name']; ?></p>
            <div class="left">
            ...
            <p class="main"><?php echo $site_details_data['details_article']; ?></p>
        </div>
    </div>
    ...
    <div id="music_div">
        <audio  id="myMusic">
            ...
            <source class="music" src="<?php echo $site_details_data['music_path']; ?>" type="audio/mpeg">
    ...
    <?php if($site_details_data['video_path']): ?> 
             <div id="video_div">
             <p class="title menu">【视频】<?php echo $site_details_data['video_title']; ?></p>
                <video controls id="myVideo" >
                    <source class="video" src="__STATIC__/<?php echo $site_details_data['video_path']; ?>" type="video/mp4">
                </video>
            </div>
        <?php else: ?> 
         <!--    <p>视频不存在</p> -->
 ...
 $(function(){
   ...
   function secondToMin(s) {
    ...
    function get_img_info(){
            ...
            var request_url = "<?php echo url('index/point/get_img_info'); ?>";
         $.ajax({  
                url:request_url,
                dataType : "json",
                type:'post',
                data:{id:'<?php echo $site_details_data['img_id']; ?>'},
    ...
    get_img_info();  
     ...
     function get_article_info(){
        var acticle_url = "<?php echo url('index/point/get_article_info'); ?>";
        var l = "";
            $.ajax({  
                url:acticle_url,
                dataType : "json",
                type:'post',
                data:{id:'<?php echo $site_details_data['article_id']; ?>'},
                 success : function(article_data) {
                  
                        console.log(article_data);
                        var  a_request_url = "<?php echo url('index/article/article_content'); ?>";
